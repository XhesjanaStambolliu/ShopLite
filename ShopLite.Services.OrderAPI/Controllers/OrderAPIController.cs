using AutoMapper;
using ShopLite.Services.OrderAPI.Data;
using ShopLite.Services.OrderAPI.Models;
using ShopLite.Services.OrderAPI.Models.Dto;
using ShopLite.Services.OrderAPI.Utility;
...
using ShopLite.Services.OrderAPI.RabbitMQSender;

namespace ShopLite.Services.OrderAPI.Controllers
{
    [Route("api/order")]
    [ApiController]
